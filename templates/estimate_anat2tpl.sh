...
ln -s anat2tpl_0GenericAffine.mat ${participant}${suffix["anat2tpl_aff"]}
ln -s anat2tpl_1Warp.nii.gz ${participant}${suffix["anat2tpl"]}
ln -s anat2tpl_1InverseWarp.nii.gz ${participant}${suffix["tpl2anat"]}
